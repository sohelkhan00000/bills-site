let rentReceipt = () => {
    class formControls {
        ...
        constructor() {
            this['renter-name'] = document.querySelector('app-main-page #renter-name');
            this['rent'] = document.querySelector('app-main-page #rent');
            this['address'] = document.querySelector('app-main-page #address');
            this['landlord-name'] = document.querySelector('app-main-page #landlord-name');
            this['landlord-pan'] = document.querySelector('app-main-page #landlord-pan');
            this['date-from'] = document.querySelector('app-main-page #date-from');
            this['date-to'] = document.querySelector('app-main-page #date-to');
            this['receipt-month'] = document.querySelectorAll("app-main-page [name='receipt-month']");
            this['download-pdf'] = document.querySelector("app-main-page #download-pdf");
            this['form-control'] = document.querySelectorAll('app-main-page .form-control');
            this['spinner-grow'] = document.querySelector("app-main-page .spinner-grow");
            this['download-text'] = document.querySelector("app-main-page .download-text");
            this['select-template'] = document.querySelector("app-main-page .select-template");
    ...
    var readyPage = () => {
        objTemplateControls = {
            'receipts': document.querySelector('app-main-page #receipts'),
            'generate-date': document.querySelectorAll('app-main-page .generate-date'),
            'current-month': document.querySelectorAll('app-main-page .current-month'),
            'receipt-number': document.querySelectorAll('app-main-page .receipt-number')
        };
        objFormControls = new formControls();
        for (let i in objFormControls) {
            if (document.querySelector("app-main-page p[data-error=" + i + "]")) {
                objErrorControls[i] = document.querySelector("app-main-page p[data-error=" + i + "]")
            }

            if (document.querySelector("app-main-page  [data-tm=" + i + "]")) {
                objTemplateControls[i] = document.querySelectorAll("app-main-page [data-tm=" + i + "]");
            }
        }
    ...
    objFormControls["form-control"].forEach(function (i) {
        ['keyup', 'change'].forEach(function (e) {
            i.addEventListener(e, function () {
                let ele = document.querySelectorAll("app-main-page ." + i.id);
                ele.forEach((e) => {
                    e.innerHTML = i.value;;
                })
            });
    ...
    var addDynamicData = (CB) => {
        ...
        let checkAllvalidation = document.querySelectorAll("app-main-page  .validation-message");
        ...
        if (isControlsValid) {
            ...
            let monthlyCheck = document.querySelector("app-main-page  #monthly");
            let monthSlot = 1;
            ...
            allDates.forEach((indexValue, index, array) => {
                if (array.length == 1) {
                    ...
                    if (index == 0) {
                        ...
                        var element = document.querySelector('app-main-page #invoice1');
                        var element2 = element.cloneNode(true);
                        element2.id = "invoice" + (index + 1);
                        objTemplateControls['receipts'].appendChild(element2);

                        document.querySelector("app-main-page #invoice" + (index + 1) + " [data-tm='date-from']").innerHTML = indexValue.start.toUpperCase();
                        document.querySelector("app-main-page #invoice" + (index + 1) + " [data-tm='date-to']").innerHTML = indexValue.end.toUpperCase();
                        document.querySelector("app-main-page #invoice" + (index + 1) + "  .current-month").innerHTML = getMonthShortName(indexValue.start);
                        document.querySelector("app-main-page #invoice" + (index + 1) + "  .receipt-number").innerHTML = (index + 1);
                        document.querySelector("app-main-page #invoice" + (index + 1) + "  .generate-date").innerHTML = getMonthShortName(today);;
    ...
    var resetPage = (CB) => {
        ...
        const elements = document.querySelector("app-main-page .invoice");
        while (elements.length > 1) {
            elements[1].parentNode.removeChild(elements[1]);
        }

        const pageBreaker = document.querySelector("app-main-page .html2pdf__page-break");
        while (pageBreaker.length > 0) {
            pageBreaker[0].parentNode.removeChild(pageBreaker[0]);
        }
        const pageAdd = document.querySelector("app-main-page .page-add");
    ...
    var generatePDF = () => {
        addDynamicData((suc, msg) => {
            if (suc) {
                ...
                const element = document.querySelector('app-main-page #receipts');
                var options = {
                    jsPDF: {
                        format: 'a4',
